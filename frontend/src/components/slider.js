  ...
  return (
    <div className="container-Slider">
      ...
      <div className="card-text2">
        <h1>Items Macchiato</h1>
        <p>We are the only brand in the world that has its own coffee production, growing the best coffee every day.</p>
        <span>We think how to improve our products generating the least ecological impact.</span>
